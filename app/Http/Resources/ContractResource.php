        ...
        return [
            ...
            'services' => $this->services->map(function ($service) {
                ...
                return [
                    ...
                    'is_cancelled'     => $service->pivot->is_cancelled,
                    'cancelled_date'     => $service->pivot->cancelled_date,
                    'is_refund'     => $service->pivot->is_refund,
                    'refund_date'     => $service->pivot->refund_date,
                    'refund_amount'     => $service->pivot->refund_amount,
